...
class Self_attention(): 
    ...
    def utilizar_SF(self,matriz_de_embeding):
        ...
        for i in range(len(matriz_de_embeding)):
            ...
            keys.append(self.obtener_keys(matriz_de_embeding[i]))
            values.append(self.obtener_values(matriz_de_embeding[i]))
    ...
    def backpropagation(self,error,numero_de_pasada):
        ...
        for col in range(len(self.ultima_salida_a[fila])):
            ...
            for i in range(len(error_de_esta_capa)):
               error_de_capa_anterior_por_palabra[col].append(error_de_esta_capa[i]) 
        ...
        def entrenar_segunda_parte():
            ...
            for col in range(len(self.ultima_salida_a[fila])):
                ...
                for elemento in range(len(pre_parte_a_del_back[col])):
                    ...
                    error_k = self.keys.backpropagation_intrared(vector_de_errores_completos_k,fila)
                    for i in range(len(error_k)):
                        error_de_capa_anterior_por_palabra[col].append(error_k[i]) 

        entrenar_segunda_parte()


        return error_de_capa_anterior_por_palabra
